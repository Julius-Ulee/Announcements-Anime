...
async function updateReadmeWithAnimeData() {
  try {
    ...
    readmeContent += `<p align="center"><a href="https://github.com/Julius-Ulee/Announcements-Anime/blob/master/LICENSE"><img src="https://img.shields.io/badge/License-MIT-yellow.svg"></a> <img src="https://github.com/Julius-Ulee/github-profile-views-counter/blob/master/svg/738176371/badge.svg"> <img height='20' src="https://github.com/Julius-Ulee/github-profile-views-counter/blob/master/graph/738176371/small/week.png"></p>`;
    readmeContent += `<p align="center"><b>Display GitHub Action Badge</b> <a href="https://github.com/Julius-Ulee/Announcements-Anime/actions/workflows/black.yml"><img src="https://github.com/Julius-Ulee/Announcements-Anime/actions/workflows/black.yml/badge.svg"></a> <a href="https://github.com/Julius-Ulee/Announcements-Anime/actions/workflows/jekyll.yml"><img src="https://github.com/Julius-Ulee/Announcements-Anime/actions/workflows/jekyll.yml/badge.svg"></a></p>`;
    readmeContent += `<p align="center"><a href="https://github.com/${{ github.repository_owner }}/${{ github.repository }}/blob/master/README.md">Read me</a> • <a href="https://github.com/${{ github.repository_owner }}/${{ github.repository }}/blob/master/.github/workflows/black.yml">Actions-YML</a> • <a href="https://github.com/${{ github.repository_owner }}/${{ github.repository }}/blob/master/.gitignore">Gitignore</a> • <a href="https://github.com/${{ github.repository_owner }}/${{ github.repository }}/blob/master/LICENSE">License</a> • <a href="https://github.com/${{ github.repository_owner }}/${{ github.repository }}/blob/master/update-readme.js">update-readme</a></p>`;
